...
export default function AddCustomer(){
   ...
   // let mockCustomer = {userId: 1, username:"appu", password:"123456", role: "Customer"};
    const initialState = {username: undefined, password: undefined, validation:{username:undefined, password: undefined}};
    ...
    const setFieldState = (reference)=>{
       ...
       setNewState({...currentState, [fieldName] : fieldValue, validation:{...currentState.validation,[fieldName]:validationMsg}});
    }
        ...
        <div className={commonStyle1.margintop30}>
            <form onSubmit={submitHandler}>
                ...
                <div className="form-group">
                    ...
                    <input name = "password" type = "password" ref = {passwordRef} placeholder="(min 4 characters)" className = "form-control"onChange={()=>setFieldState(passwordRef)}required/>
                </div>
